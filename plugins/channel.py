...
from plugins.botutils.Imdbposter import get_movie_detailsx, fetch_image, get_movie_details
...
pending_updates = {}
error_tmdb = False  # module-level init; set per-call in _process_with_lock
